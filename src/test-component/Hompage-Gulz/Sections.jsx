        ...
        <div>
          ...
          {data.hero_desktop_img && !heroDesktopImg && (
            <div className="mt-2">
              ...
              <img src={data.hero_desktop_img} alt="Hero Desktop Image" className="mt-1 h-12 object-contain" />
            </div>
          )}
        </div>
        ...
        <div>
          ...
          {data.hero_mobile_img && !heroMobileImg && (
            <div className="mt-2">
              ...
              <img src={data.hero_mobile_img} alt="Hero Mobile Image" className="mt-1 h-12 object-contain" />
            </div>
          )}
        </div>
      </div>
        ...
        <div>
          ...
          {data.legacy_img && !legacyImage && (
            <div className="mt-2">
              ...
              <img src={data.legacy_img} alt="Legacy Image" className="mt-1 h-12 object-contain" />
            </div>
          )}
        </div>
      </div>
        ...
        <div>
          ...
          {data.curator_img && !curatorImage && (
            <div className="mt-2">
              ...
              <img src={data.curator_img} alt="Curator Image" className="mt-1 h-12 object-contain" />
            </div>
          )}
        </div>
      </div>
        ...
        <div>
          ...
          {data.trending_img && !trendingImage && (
            <div className="mt-2">
              ...
              <img src={data.trending_img} alt="Trending Image" className="mt-1 h-12 object-contain" />
            </div>
          )}
        </div>
      </div>
