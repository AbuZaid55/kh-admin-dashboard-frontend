...
export const CollectionSection = ({ data, setData, onToggle }) => {
    const [formData, setFormData] = useState({
...
export const JewelAtGlanceSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
...
export const CategorySection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {categorySectionImages.length > 0 && (
            <div className="mt-2">
...
export const CuratorThoughtSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
