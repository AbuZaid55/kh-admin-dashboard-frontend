...
export const HallmarkSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
...
export const HighJewelSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
...
export const QOHSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
...
export const BridalEditSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
...
export const PolkiEditSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {data.polki_edit_image && (
             <img src={`http://localhost:4000/${data.polki_edit_image}`} alt={data.bridal_edit_title} className="mt-2 h-20 object-cover" />
           )}
        </div>
      </div>
    </SectionManagement>
...
export const ComingSoonSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
...
export const StoreSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
...
export const StoreFeatureSection = ({ data, setData, onToggle }) => {
...
export const FAQSection = ({ data, setData, onToggle }) => {
  const [formData, setFormData] = useState({
