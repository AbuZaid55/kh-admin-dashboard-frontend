...
const SEOManagement = () => {
  // const [seoEntries, setSeoEntries] = useState([]); production
  const [seoEntries, setSeoEntries] = useState([ // For Testing 
    {
      canonical: "https://www.khwaahish.com/",
      created_at: "2025-03-17T04:32:06.015Z",
      description: "Shop latest diamond jewellery at Khwaahish, Chennai's best diamond jewellery shop. ✔BIS Hallmarked ✔Certified Natural Diamonds ✔Online or in-store.",
      meta_name_twitter: [
        { name: "twitter:card", content: "summary", _id: "67d7a5c6926189de1aa97d65" },
        { name: "twitter:title", content: "Certified Designer Diamond Jewellery In Chennai", _id: "67d7a7f9926189de1aa97d91" },
        { name: "twitter:description", content: 'content="Stylish, elegant & trendy diamond jewellery at Khwaahish."', _id: "67d7a7f9926189de1aa97d92" },
        { name: "twitter:image", content: "https://emcgtdx36wv.exactdn.com/storage/2024/01/homepage-different-by-design-mobile-banner.jpg", _id: "67d7a7f9926189de1aa97d93" },
        { name: "twitter:label1", content: "Written by", _id: "67d7a7f9926189de1aa97d94" },
        { name: "twitter:data1", content: "Khwaahish Team", _id: "67d7a7f9926189de1aa97d95" },
        { name: "twitter:label2", content: "Time to read", _id: "67d7a7f9926189de1aa97d96" },
        { name: "twitter:data2", content: "Less than a minute", _id: "67d7a7f9926189de1aa97d97" }
      ],
      meta_property_og: [
        { property: "og:locale", content: "en_US", _id: "67d7a5c6926189de1aa97d63" },
        { property: "og:type", content: "website", _id: "67d7a5c6926189de1aa97d64" },
        { property: "og:title", content: "Chennai's Most Exclusive Designs In Certified Natural Diamonds", _id: "67d7a7f9926189de1aa97d85" },
        { property: "og:description", content: "Stylish, elegant & trendy diamond jewellery at Khwaahish.", _id: "67d7a7f9926189de1aa97d86" },
        { property: "og:url", content: "https://www.khwaahish.com/", _id: "67d7a7f9926189de1aa97d87" },
        { property: "og:site_name", content: "Khwaahish Diamonds", _id: "67d7a7f9926189de1aa97d88" },
        { property: "og:updated_time", content: "2024-11-13T15:55:50+05:30", _id: "67d7a7f9926189de1aa97d89" },
        { property: "og:image", content: "https://emcgtdx36wv.exactdn.com/storage/2024/01/homepage-different-by-design-desktop-banner.jpg", _id: "67d7a7f9926189de1aa97d8a" },
        { property: "og:image:secure_url", content: "https://emcgtdx36wv.exactdn.com/storage/2024/01/homepage-different-by-design-desktop-banner.jpg", _id: "67d7a7f9926189de1aa97d8b" },
        { property: "og:image:width", content: "1920", _id: "67d7a7f9926189de1aa97d8c" },
        { property: "og:image:height", content: "1280", _id: "67d7a7f9926189de1aa97d8d" },
        { property: "og:image:alt", content: "A captivating display of exquisite bridal diamond jewelry, radiating elegance and luxury.", _id: "67d7a7f9926189de1aa97d8e" },
        { property: "og:image:type", content: "image/jpeg", _id: "67d7a7f9926189de1aa97d8f" }
      ],
      page: "https://www.khwaahish.com/",
      page_name: "homepage_khwaahish",
      robots: "follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large",
      title: "Famous & Trusted Diamond Jewellers In Chennai | Khwaahish",
      updated_at: "2025-03-17T04:41:29.529Z",
      __v: 0,
      _id: "67d7a5c5926189de1aa97d62"
    }
  ]);
  ...
  return (
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full p-2 border rounded ${formErrors.page_name ? 'border-red-500' : 'border-gray-300'}`}
            />
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`w-full p-2 border rounded ${formErrors.page ? 'border-red-500' : 'border-gray-300'}`}
            />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-2 border rounded ${formErrors.meta_property_og && formErrors.meta_property_og[index]?.property ? 'border-red-500' : 'border-gray-300'}`}
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full p-2 border rounded ${formErrors.meta_name_twitter && formErrors.meta_name_twitter[index]?.name ? 'border-red-500' : 'border-gray-300'}`}
                    />
          ...
          <div className="flex gap-4">
            ...
            >
              {formMode === 'create' ? 'Create SEO Entry' : 'Update SEO Entry'}
            </button>
            <button 
              type="button" 
              onClick={() => {
    ...
    {seoEntries.length > 0 && (
      <div className="flex justify-between items-center mt-6">
        ...
        <div className="flex space-x-2">
          <button className="bg-gray-200 text-gray-800 p-2 rounded disabled:opacity-50" disabled>
            Previous
          </button>
