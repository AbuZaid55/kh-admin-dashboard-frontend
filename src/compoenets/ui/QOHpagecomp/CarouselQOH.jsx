...
function CarouselQOH({slides, setslides,editSlideIndex, seteditSlideIndex,handleform,formdata, setformdata}) {
                                            ...
                                            <div className=' w-[90%]'>
                                                <div className=' flex gap-11'>
                                                    <div className=' flex flex-col gap-2'>
                                                        ...
                                                        <p className=' text-md text-gray-500'>{slide.title}</p>
                                                    </div>
